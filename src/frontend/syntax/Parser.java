...
public class Parser {
    ...
    private ConstDecl parseConstDecl() {
        ArrayList<Node> children = new ArrayList<>();
        if (lexer.getLexType().equals(LexType.CONSTTK)) {
            children.add(new LeafNode(SyntaxType.CONSTTK, "const"));
            lexer.next();
        } else {
            error();
        }
        if (lexer.getLexType().equals(LexType.INTTK)) {
            children.add(new LeafNode(SyntaxType.INTTK, "int"));
            lexer.next();
        } else {
            error();
        }
        ...
        while (lexer.getLexType().equals(LexType.COMMA)) {
            children.add(new LeafNode(SyntaxType.COMMA, ","));
            lexer.next();
            children.add(parseConstDef());
        }
        if (lexer.getLexType().equals(LexType.SEMICN)) {
            children.add(new LeafNode(SyntaxType.SEMICN, ";"));
            lexer.next();
    ...
    private ConstDef parseConstDef() {
        ...
        if (lexer.getLexType().equals(LexType.IDENFR)) {
            children.add(new LeafNode(SyntaxType.IDENFR, lexer.getToken()));
            lexer.next();
        } else {
            error();
        }
        ...
        while (lexer.getLexType().equals(LexType.LBRACK)) {
            children.add(new LeafNode(SyntaxType.LBRACK, "["));
            lexer.next();
            children.add(parseConstExp());
            if (lexer.getLexType().equals(LexType.RBRACK)) {
                children.add(new LeafNode(SyntaxType.RBRACK, "]"));
                lexer.next();
            } else {
                error();
                return null;
        ...
        if (lexer.getLexType().equals(LexType.ASSIGN)) {
            children.add(new LeafNode(SyntaxType.ASSIGN, "="));
            lexer.next();
    ...
    private ConstInitVal parseConstInitVal() {
        ...
        if (lexer.getLexType().equals(LexType.LBRACE)) {
            children.add(new LeafNode(SyntaxType.LBRACE, "{"));
            lexer.next();
            children.add(parseConstInitVal());
            while (lexer.getLexType().equals(LexType.COMMA)) {
                children.add(new LeafNode(SyntaxType.COMMA, ","));
            ...
            if (lexer.getLexType().equals(LexType.RBRACE)) {
                children.add(new LeafNode(SyntaxType.RBRACE, "}"));
                lexer.next();
    ...
    private FuncDef parseFuncDef() {
        ...
        if (lexer.getLexType().equals(LexType.LPARENT)) {
            children.add(new LeafNode(SyntaxType.LPARENT, "("));
            lexer.next();
            if (lexer.getLexType().equals(LexType.RPARENT)) {
                children.add(new LeafNode(SyntaxType.RPARENT, ")"));
                lexer.next();
    ...
    private MainFuncDef parseMainFuncDef() {
        ...
        if (lexer.getLexType().equals(LexType.MAINTK)) {
            children.add(new LeafNode(SyntaxType.MAINTK, "main"));
            lexer.next();
        } else {
            error();
            return null;
    ...
    private FuncType parseFuncType() {
        ...
        children.add(lexer.getLexType().equals(LexType.VOIDTK) ?
                new LeafNode(SyntaxType.VOIDTK, "void") : new LeafNode(SyntaxType.INTTK, "int"));
        lexer.next();
    ...
    private Stmt parseStmt() {
        ...
        if (lexer.getLexType().equals(LexType.IFTK)) {
            ...
            children.add(new LeafNode(SyntaxType.BREAKTK, "break"));
            lexer.next();
        } else if (lexer.getLexType().equals(LexType.CONTINUETK)) {
            children.add(new LeafNode(SyntaxType.CONTINUETK, "continue"));
            lexer.next();
        } else if (lexer.getLexType().equals(LexType.RETURNTK)) {
            children.add(new LeafNode(SyntaxType.RETURNTK, "return"));
            lexer.next();
            if (!lexer.getLexType().equals(LexType.SEMICN)) {
                children.add(parseExp());
            }
            ...
            if (lexer.getLexType().equals(LexType.ASSIGN)) {
                ...
                if (lexer.getLexType().equals(LexType.GETINTTK)) {
                    children.add(new LeafNode(SyntaxType.GETINTTK, "getint"));
                    lexer.next();
                    children.add(new LeafNode(SyntaxType.LPARENT, "("));
                    lexer.next();
                    children.add(new LeafNode(SyntaxType.RPARENT, ")"));
    ...
    private Stmt parseStmtIf() {
        ArrayList<Node> children = new ArrayList<>();
        if (lexer.getLexType().equals(LexType.IFTK)) {
            children.add(new LeafNode(SyntaxType.IFTK, "if"));
            lexer.next();
        } else {
            error();
            return null;
        ...
        if (lexer.getLexType().equals(LexType.ELSETK)) {
            children.add(new LeafNode(SyntaxType.ELSETK, "else"));
            lexer.next();
            children.add(parseStmt());
        }
        return new Stmt(children);
    ...
    private Stmt parseStmtFor() {
        ...
        if (lexer.getLexType().equals(LexType.FORTK)) {
            children.add(new LeafNode(SyntaxType.FORTK, "for"));
            lexer.next();
        } else {
            error();
            return null;
    ...
    private Stmt parseStmtPrint() {
        ArrayList<Node> children = new ArrayList<>();
        children.add(new LeafNode(SyntaxType.PRINTFTK, "printf"));
        lexer.next();
        children.add(new LeafNode(SyntaxType.LPARENT, "("));
        lexer.next();
        children.add(new LeafNode(SyntaxType.STRCON, lexer.getToken()));
        lexer.next();
        while (lexer.getLexType().equals(LexType.COMMA)) {
            children.add(new LeafNode(SyntaxType.COMMA, ","));
            lexer.next();
    ...
    private Number parseNumber() {
        ...
        if (lexer.getLexType().equals(LexType.INTCON)) {
            children.add(new LeafNode(SyntaxType.INTCON, lexer.getToken()));
            lexer.next();
    ...
    // UnaryExp -> Primary | Ident '(' [FuncRParams] ')'
    ...
    private UnaryOp parseUnaryOp() {
        ...
        children.add(new LeafNode(syntaxType, lexer.getToken()));
        lexer.next();
